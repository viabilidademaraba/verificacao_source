        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              questaoGenerica("O nome de identificação do empreendimento é:",
                  widget.data[0]),
              questaoGenerica(
              ...
              questaoGenerica(
                  ...
                  resultadoUso(widget.data[4], widget.data[6], widget.data[2])),
              questaoGenerica(
              ...
              WContainer(
                ...
                child: Column(
                  children: [
                    parametro(
                        [true, "A área total do lote é ${widget.data[11]} m²"]),
                    parametro(getCotaAltimetrica(widget.data[12])),
                    parametro(getCoeficienteAproveitamento(widget.data[13],
                        widget.data[5], widget.data["option1"])),
                    parametro(getTaxaOcupacao(widget.data[14], widget.data[3],
                        widget.data[6], widget.data[2])),
                    parametro(getTaxaPermeabilidade(widget.data[15])),
                    parametro(getRecuoFrontal(widget.data[16], widget.data[3],
                        widget.data[6], widget.data[2])),
                    parametro(getRecuoFundo(widget.data[17], widget.data[3],
                        widget.data[6], widget.data[2])),
                    parametro(getRecuoLateralDireita(widget.data[18],
                        widget.data[3], widget.data[6], widget.data[2])),
                    parametro(getRecuoLateralEsquerda(
                        widget.data[19], widget.data[6])),
                    parametro(getRecuoLateralEsquina(widget.data[20],
                        widget.data[3], widget.data[6], widget.data[2])),
                    parametro(getAlturaEdificacao(
                        widget.data[21], widget.data[23], widget.data[16])),
                    parametro(getLarguraFrente(widget.data[22], widget.data[3],
                        widget.data[6], widget.data[2]))
                  ],
                ),
              ),
