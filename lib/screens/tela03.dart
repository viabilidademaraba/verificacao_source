              ...
              WContainer(
                ...
                child: Column(
                  children: [
                    ...
                    parametro(
                        getCotaAltimetrica(double.parse(widget.data[12]))),
                    parametro(getCoeficienteAproveitamento(
                        double.parse(widget.data[13]),
                        widget.data[5],
                        widget.data["option1"])),
                    parametro(getTaxaOcupacao(double.parse(widget.data[14]),
                        widget.data[3], widget.data[6], widget.data[2])),
                    parametro(
                        getTaxaPermeabilidade(double.parse(widget.data[15]))),
                    parametro(getRecuoFrontal(double.parse(widget.data[16]),
                        widget.data[3], widget.data[6], widget.data[2])),
                    parametro(getRecuoFundo(double.parse(widget.data[17]),
                        widget.data[3], widget.data[6], widget.data[2])),
                    ...
                    parametro(getLarguraFrente(double.parse(widget.data[22]),
                        widget.data[3], widget.data[6], widget.data[2]))
                  ],
                ),
              ),
